...
import com.github.nikolaymenzhulin.naf_presentation_layer.android_test.presentation.view.fragment.test_data.fragment.view_model.TestViewModelFragmentInjector.TestViewModelFragmentModule
...
class TestViewModelFragmentInjector(
    ...
    interface TestViewModelFragmentComponent : ViewComponent<TestViewModelFragment>
    ...
    override fun getViewComponent(module: TestViewModelFragmentModule): ViewComponent<TestViewModelFragment> =
        DaggerTestViewModelFragmentInjector_TestViewModelFragmentComponent.builder()
