...
@PerActivity
class TestViewModelActivityNavDelegate @Inject constructor(
    override val router: Router,
    override val route: TestViewModelActivityRoute
) : AbstractNavDelegate<Router, TestViewModelActivityRoute>()